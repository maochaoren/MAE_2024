...
class EarlyStopping:
    def __init__(self, is_early_stop=True , patience=7, verbose=False, delta=0):
    ...
    def save_checkpoint(self, val_loss, model, path):
        if self.is_early_stop and self.verbose:
...
class AggregationRebuild(torch.nn.Module):
    ...
    def forward(self, similarity_matrix, batch_emb_om):
        ...
        #print(batch_emb_om.shape, rebuild_weight_matrix.shape)
